...
public interface IPlateforme extends Remote {
	void inscriptionTuteur(ITuteur tuteur) throws RemoteException;
	...
	public List<ITuteur> rechercherParDisponibilite(Integer jour, Double heureDebut, Double heureFin) throws RemoteException;
